...
if (!system){
    throw new Error("No system exists for id: " + parameters.system);
}

if (system.apiKey){
    return { "headers": { "ZSessionID": system.apiKey}};
}

if (!system.username && !system.pw){
    throw new Error("Incomplete authentication credentials provided.  Please ensure an apiKey or username/pw combination is provided in the system configuration for system: " + paramerters.system);
}
