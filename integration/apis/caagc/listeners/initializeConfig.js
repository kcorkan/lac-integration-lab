...
gCFG.initialize("catalystUrl", "http://localhost:8080/rest/integration/orchestrator/v1/catalyst");
gCFG.initialize("acApiDefIdent", 1);  
gCFG.initialize("maxRallyPageSize", 100);
gCFG.initialize("fetchBackSeconds", 30);
