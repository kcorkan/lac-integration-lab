...
gCFG.initialize("xrefCatalystUrl", 'http://localhost:8080/rest/integration/orchestrator/v1/xref_catalyst');
gCFG.initialize("runReactionUrl", 'http://localhost:8080/rest/integration/orchestrator/v1/runReactionBatch');
